...
Love the Beamer look but working in [Quarto](https://quarto.org) instead of R
Markdown? The same UIUC Beamer aesthetics are also shipped as **standalone Quarto
format extensions** in [`_extensions/`](_extensions). These do not require the R
package — install them into any Quarto project with:
