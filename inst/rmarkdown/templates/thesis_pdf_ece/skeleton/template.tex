...
$committee-members.name$$if(committee-members.position)$, $committee-members.position$$endif$
$sep$\\
$endfor$
}
$endif$
...
% BIBLIOGRAPHY
%
\bibliographystyle{$if(biblio-style)$$biblio-style$$else$IEEE_ECE$endif$}
