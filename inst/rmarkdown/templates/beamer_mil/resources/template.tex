...
\definecolor{beamer@UIUCblue}{RGB}{25,45,65}
\definecolor{beamer@UIUCorange}{RGB}{232,74,39}
\definecolor{beamer@UIUCorange2}{RGB}{232,98,39}
...
\definecolor{beamer@UIUCgray}{gray}{0.85}

\setbeamercolor{title}{fg=black,bg=beamer@UIUCgray}
\setbeamercolor{frametitle}{fg=black,bg=beamer@UIUCgray}
\setbeamercolor{normal text}{fg=black}

% Boxes
\setbeamercolor{title in head/foot}{fg=black,bg=beamer@UIUCgray}
\setbeamercolor{author in head/foot}{fg=black,bg=beamer@UIUCgray}
\setbeamercolor{date in head/foot}{fg=black,bg=beamer@UIUCgray}
%\setbeamercolor{date in head/foot}{fg=beamer@UIUCblue,bg=beamer@UIUCgray}
...
% Setup blocks
\setbeamercolor{block title}{fg = black, bg = beamer@UIUCgray}
...
\setbeamercolor{block title example}{fg = black, bg = beamer@UIUCgray}
...
$endif$
$if(strikeout)$
\usepackage[normalem]{ulem} % avoid problems with \sout in headers with hyperref:
