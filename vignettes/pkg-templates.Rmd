...
![`beamer_imetropolis` Beamer LaTeX Template](beamer_imetropolis.png){width=300px height=400px}
...
![`html_imetropolis` HTML Template](html_imetropolis.png){width=300px height=400px}
